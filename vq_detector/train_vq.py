...
def train(model, args, train_loader, val_loader=None, max_train_epochs=1, alpha=10, validate_every=10000, writer=None):
    model.to(device)
    model.train()
...
if __name__ == '__main__':
    ...
    val_dataloader = get_chunked_h5dataloader(config_path=args.data_config, split='valid')
